...
public class cryptodb extends ContentProvider {
    public cryptodb() {
    }

    static final String PROVIDER_NAME = "com.cryptodb.www";
    ...
    static final String DATABASE_NAME = "cryptodb1";
    static final String STUDENTS_TABLE_NAME = "students";
    static final int DATABASE_VERSION = 1;
    static final String CREATE_DB_TABLE = " CREATE TABLE " +STUDENTS_TABLE_NAME +
            " (_id INTEGER PRIMARY KEY AUTOINCREMENT, " + " name TEXT NOT NULL, " + " password TEXT NOT NULL,"+" status TEXT NOT NULL);";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri))
        {
            ...
            case STUDENT_ID: String id = uri.getPathSegments().get(1);
                ...
                break;
            default: throw new IllegalArgumentException("Unknown URI " + uri); } getContext().getContentResolver().notifyChange(uri, null);
        return count;
    }
